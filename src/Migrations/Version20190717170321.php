 ...
 */
final class Version20190717170321 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE salle (id INT AUTO_INCREMENT NOT NULL, niveau_id INT DEFAULT NULL, semestre_id INT DEFAULT NULL, parcour_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, INDEX IDX_4E977E5CB3E9C81 (niveau_id), INDEX IDX_4E977E5C5577AFDB (semestre_id), INDEX IDX_4E977E5C9A561E99 (parcour_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE scolarite_image (id INT AUTO_INCREMENT NOT NULL, url_id INT DEFAULT NULL, niveau_id INT DEFAULT NULL, INDEX IDX_A8E0A9C881CFDAE7 (url_id), UNIQUE INDEX UNIQ_A8E0A9C8B3E9C81 (niveau_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
