 ...
 */
final class Version20190813194006 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE note CHANGE is_final is_final TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE semestre_niveaux (semestre_id INT NOT NULL, niveaux_id INT NOT NULL, INDEX IDX_FDAD8D665577AFDB (semestre_id), INDEX IDX_FDAD8D66AAC4B70E (niveaux_id), PRIMARY KEY(semestre_id, niveaux_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE note CHANGE is_final is_final TINYINT(1) DEFAULT NULL');
