 ...
 */
final class Version20190804183725 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE information (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, contenu LONGTEXT NOT NULL, add_at DATETIME NOT NULL, INDEX IDX_29791883A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE information_child (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, information_id INT DEFAULT NULL, contenu LONGTEXT NOT NULL, add_at DATETIME NOT NULL, INDEX IDX_419490F9A76ED395 (user_id), INDEX IDX_419490F92EF03101 (information_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE school (id INT AUTO_INCREMENT NOT NULL, begin_at DATETIME NOT NULL, end_at DATETIME DEFAULT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE information_child ADD CONSTRAINT FK_419490F9A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE information_child ADD CONSTRAINT FK_419490F92EF03101 FOREIGN KEY (information_id) REFERENCES information (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE information_child DROP FOREIGN KEY FK_419490F92EF03101');
        ...
        $this->addSql('ALTER TABLE information_child DROP FOREIGN KEY FK_419490F9A76ED395');
        ...
        $this->addSql('DROP TABLE information_child');
